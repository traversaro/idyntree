...
#ifndef TORQUE_ESTIMATION_TREE_WO_KDL_H
#define TORQUE_ESTIMATION_TREE_WO_KDL_H
...
namespace iCub
{
    ...
    namespace iDynTree
    {
         ...
         * Joint Torque estimation as TorqueEstimationTree, but only
         * using iDynTree data structures (no KDL nor YARP vectors).
         */
        class TorqueEstimationTreeWoKDLWoKDL : public DynTree
        {
        private:
            //dynContact stuff
        ...
        public:
            ...
            /**
             * Constructor for TorqueEstimationTreeWoKDL
             *
             *
             * @param urdf_filename
             * @param verbose
             */
            TorqueEstimationTreeWoKDL(std::string urdf_filename,
            ...
            TorqueEstimationTreeWoKDL(KDL::Tree & icub_kdl,
            ...
            virtual ~TorqueEstimationTreeWoKDL();
#endif
        };
