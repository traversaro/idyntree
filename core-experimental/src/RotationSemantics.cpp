...
namespace iDynTree
{
    ...
    bool RotationSemantics::convertToNewCoordFrame(const PositionSemantics & op, PositionSemantics & result) const
    {
        // check semantics
        bool status = this->check_convertToNewCoordFrame(op);
